...
export default function CTA() {
  return (
    <section id="launch" className="relative py-20 sm:py-24 bg-gradient-to-b from-slate-900 to-slate-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-white/10 bg-white/5 p-8 sm:p-12 text-center">
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-3 justify-center">
            <a href="#" className="inline-flex justify-center items-center rounded-lg bg-red-500 text-white px-6 py-3 font-semibold shadow-lg shadow-red-500/30 hover:bg-red-600 transition-colors">
              Connect wallet
            </a>
